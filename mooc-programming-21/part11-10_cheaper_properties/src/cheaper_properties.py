...
def cheaper_properties(properties:list,reference:RealProperty):
    return [(item,item.price_difference(reference)) for item in properties if item.more_expensive(reference)==False]
...
if __name__=="__main__":
    ...
    a6=RealProperty(25,1200,2500,"Coutryside mansion")
